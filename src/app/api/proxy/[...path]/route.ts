...
export async function POST(
  ...
  try {
    ...
    console.log(
      "POST Request - No body or invalid JSON, using empty object",
      error
    );
  }
  ...
  try {
    ...
    try {
      ...
      console.log("POST Response - No body or invalid JSON", e);
    }
